...
function getData() {
    ...
    function printImageToConsole(pythonArray) {
        for (var j = 0; j <= pythonArray.length - 28; j = j + 28) {
            console.log(
                //print the image
                  pythonArray[j] + pythonArray[j + 1] + ""
                + pythonArray[j + 2] + pythonArray[j + 3] 
                + pythonArray[j + 4] + pythonArray[j + 5]
                + pythonArray[j + 6] + pythonArray[j + 7] 
                + pythonArray[j + 8] + pythonArray[j + 9] 
                + pythonArray[j + 10] + pythonArray[j + 11]
                + pythonArray[j + 12] + pythonArray[j + 13]
                + pythonArray[j + 14] + pythonArray[j + 15] 
                + pythonArray[j + 16] + pythonArray[j + 17]
                + pythonArray[j + 18] + pythonArray[j + 19]
                + pythonArray[j + 20] + pythonArray[j + 22] 
                + pythonArray[j + 23] + pythonArray[j + 24] 
                + pythonArray[j + 25]+ pythonArray[j + 26] 
                + pythonArray[j + 27] + "\n")
        }
        console.log("\n")
    }
